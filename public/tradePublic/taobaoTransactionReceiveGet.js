...
function taobaoTransactionReceiveGet({query,callback,errCallback=undefined}){
	...
	qnRouter({
        ...
        errCallback:(error)=>{
            if (errCallback) {
            	...
            	showErrorDialog('温馨提示','获取交易详情失败，请稍候再试！',JSON.stringify(error));
            }
        }
    })
}

export default taobaoTransactionReceiveGet;
